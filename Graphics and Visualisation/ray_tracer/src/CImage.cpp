...
//    cv::rectangle(this->img, {(10), 400-10}, {92, 400-92}, cv::Scalar(0, 0, 0), -1);
//    cv::rectangle(this->img, {(10+5+92), 400-10}, {5+92+92, 400-92}, cv::Scalar(0.25, 0.25, 0.25), -1);
//    cv::rectangle(this->img, {(10+10+92+92), 400-10}, {10+92+92+92, 400-92}, cv::Scalar(0.5, 0.5, 0.5), -1);
//    cv::rectangle(this->img, {(10+15+92+92+92), 400-10}, {15+92+92+92+92, 400-94}, cv::Scalar(0.75, 0.75, 0.75), -1);
//    cv::rectangle(this->img, {(10+20+92+92+92+92), 400-10}, {20+92+92+92+92+92, 400-94}, cv::Scalar(1, 1, 1), -1);
}
